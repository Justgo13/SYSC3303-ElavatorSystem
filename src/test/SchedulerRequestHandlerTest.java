...
class SchedulerRequestHandlerTest {
	...
	void testSameFloorIdle() {
		FloorDataMessage request = new FloorDataMessage(0.0f, 1, DirectionEnum.UP_DIRECTION, 0, false);
	...
	void testSameDirectionClosest() {
		FloorDataMessage request = new FloorDataMessage(0.0f, 4, DirectionEnum.UP_DIRECTION, 6, false);
		ArrayList<SchedulerElevatorData> elevators = new ArrayList<>();
		ArrayList<Integer> e1Dest = new ArrayList<>();
		e1Dest.add(15);
		...
		request = new FloorDataMessage(0.0f, 7, DirectionEnum.DOWN_DIRECTION, 4, false);
	...
	void testDestinationClosest() {
		...
		request = new FloorDataMessage(0.0f, 7, DirectionEnum.UP_DIRECTION, 12, false);
		elevators = new ArrayList<>();
		e1Dest = new ArrayList<>();
		e1Dest.add(4);
		e1Dest.add(5);
